...
public enum Aim {
    ...
    WEST(0, -1, 'w');
  	...
  	private static final Map<Aim, Aim> rightLookup = new HashMap<Aim, Aim>();
  	private static final Map<Aim, Aim> leftLookup = new HashMap<Aim, Aim>();
  	private static final Map<Aim, Aim> behindLookup = new HashMap<Aim, Aim>();
