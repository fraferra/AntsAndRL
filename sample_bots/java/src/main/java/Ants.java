...
public class Ants {
    ...
    /**
     * Returns the closest enemy ant
     *
     * @return the closest enemy ant
     */
    public Tile getClosestEnemyAnt(final Tile loc) {
        return getClosest(loc, getEnemyAnts());
    }
    ...
    /**
     * Returns the closest enemy hill
     *
     * @return the closest enemy hill
     */
    public Tile getClosestEnemyHill(final Tile loc) {
        return getClosest(loc, getEnemyHills());
    }
     ...
     */
    public Tile getClosestFood(final Tile loc) {
        return getClosest(loc, getFoodTiles());
    }
    ...
    private Tile getClosest(Tile loc, Set<Tile> tiles) {
        int distance = Integer.MAX_VALUE;
        Tile closest = null;

        for (Tile food : tiles) {
            int d = getDistance(loc, food);
            if (d < distance) {
                closest = food;
                distance = d;
            }
